...
function TopPerformingStocksScreen({
  navigation,
}: {
...
export default function TopPerformingStocks() {
  return (
    <NavigationContainer>
      ...
      >
        <Stack.Screen name="Watchlist" component={TopPerformingStocksScreen} />
        <Stack.Screen name="Orders" component={TopPerformingStocksScreen} />
        <Stack.Screen name="Portfolio" component={TopPerformingStocksScreen} />
        <Stack.Screen name="Funds" component={TopPerformingStocksScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
